#pragma once
#include "Struct.h"
ref class ResponseChangePassword:public StructClass
{
public:
public:
	bool isSuccessful;
	...
	ResponseChangePassword(bool isSucc, String^ errMsg) {
		isSuccessful = isSucc;
		errorMessage = errMsg;
	}
	...
	virtual array<Byte>^ pack()override {
		...
		byteData->AddRange(BitConverter::GetBytes(int(StructClass::MessageType::ResponseChangePassword)));
